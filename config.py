...
try:
    ...
    logging.warning("DB_CHANNEL is not a valid number. Check your environment variables.")
    DB_CHANNEL = -1001234567890

try:
    LOG_CHANNEL = int(os.environ.get("LOG_CHANNEL", "-1001234567891"))
except ValueError:
    logging.warning("LOG_CHANNEL is not a valid number. Check your environment variables.")
